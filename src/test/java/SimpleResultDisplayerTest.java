...
public class SimpleResultDisplayerTest {
    ...
    public void getResultText_EmptySuccessful() {
        ...
        String string = new SimpleResultDisplayer().getResultText(getEmpty());
    ...
    public void getResultText_Null() {
        new SimpleResultDisplayer().getResultText(null);
    }

    @Test
    public void getResultText_NormalFromTester() {
        String string = new SimpleResultDisplayer().getResultText(new SiteTester(getMockNormal()).test());
    ...
    public void getResultText_ImagesOnlyFromTester() {
        String string = new SimpleResultDisplayer().getResultText(new SiteTester(getMockImagesOnly()).test());
